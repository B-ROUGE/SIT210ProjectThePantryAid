...
class Makerverse_hx710c():
    ...
    def calibrate(self, weight=50, samples=50):
        ...
        UI_SensorCalibration(False, False, False)
        sleep_ms(500)
        ...
        while True:
            ...
            if(status[2]):
                break
            UI_SensorCalibration(False, False, False)
        UI_SensorCalibration(False, True, False)
        ...
        UI_SensorCalibration(True, False, False)
        sleep_ms(500)
        status = touchSensor.read()
        while True:
            sleep_ms(100)
            ...
            if(status[2]):
                break
            UI_SensorCalibration(True, False, False)
        UI_SensorCalibration(True, True, False)
        ...
        UI_SensorCalibration(False, False, True)
        sleep_ms(2000)
